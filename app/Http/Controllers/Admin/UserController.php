...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.user.index')->with('success', 'Data anggota berhasil ditambahkan.');
    }
    ...
    public function destroy(User $user)
    {
        ...
        $user->delete();
        return redirect()->route('admin.user.index')->with('success', 'Data anggota berhasil dihapus.');
    }
}